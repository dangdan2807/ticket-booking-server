...
exports.mappingTranslate = void 0;
exports.mappingTranslate = {
    FEMALE: 'Nữ',
    MALE: 'Nam',
    ...
    DESCRIPTION_BETWEEN_1_1000_CHARACTERS: 'Mô tả thông tin phải từ 1 đến 1000 ký tự',
    ...
    CONFIRM_NEW_PASSWORD_MIN_6_CHARACTERS: 'Mật khẩu xác nhận phải có ít nhất 6 ký tự',
    ...
    GENDER_IS_ENUM: 'Giới tính chỉ nhận 1 trong 3 giá trị sau: MALE, FEMALE, OTHER',
    ...
    CUSTOMER_GROUP_ID_MUST_BE_36_CHARACTERS: 'Mã nhóm khách hàng phải có 36 ký tự',
    ...
    CUSTOMER_GROUP_ID_OR_CUSTOMER_GROUP_CODE_REQUIRED: 'Id nhóm khách hàng hoặc mã nhóm khách hàng không được để trống',
    ...
    FROM_PROVINCE_CODE_GREATER_THAN_OR_EQUAL_TO_0: 'mã tỉnh thành đến phải lớn hơn hoặc bằng 0',
    TO_PROVINCE_CODE_GREATER_THAN_OR_EQUAL_TO_0: 'mã tỉnh thành đi phải lớn hơn hoặc bằng 0',
    ...
    PROVINCE_TYPE_BETWEEN_1_50_CHARACTERS: 'loại tỉnh thành phải từ 1 đến 50 ký tự',
    ...
    FROM_STATION_AND_TO_STATION_IS_SAME: 'Bến xe đi và bến xe đến không được trùng nhau',
    ...
    SEAT_IDS_OR_SEAT_CODES_REQUIRED: 'Danh sách id ghế hoặc danh sách mã ghế không được để trống',
    SEAT_ID_OR_SEAT_CODE_REQUIRED: 'Id ghế hoặc mã ghế không được để trống',
    SEAT_IS_SOLD: 'Ghế này đã được đặt',
    TRIP_DETAIL_CODE_OR_TRIP_CODE_REQUIRED: 'Mã chuyến xe hoặc mã tuyến không được để trống',
    ...
    END_DATE_MUST_BE_GREATER_THAN_OR_EQUAL_TO_NOW: 'Ngày kết thúc phải lớn hơn hoặc bằng ngày hiện tại',
    END_DATE_MUST_BE_GREATER_THAN_START_DATE: 'Ngày kết thúc phải lớn hơn ngày bắt đầu',
    END_DATE_MUST_BE_GREATER_THAN_OR_EQUAL_TO_START_DATE: 'Ngày kết thúc phải lớn hơn hoặc bằng ngày bắt đầu',
    ...
    START_DATE_NOT_MORE_THAN_7_DAYS_FROM_END_DATE: 'Ngày bắt đầu không được quá 7 ngày so với ngày kết thúc',
    DEPARTURE_DATE_GREATER_THAN_OR_EQUAL_TO_CURRENT_DATE_PLUS_15_MINUTES: 'Thời gian khởi hành phải lớn hơn hoặc bằng hiện tại + 15 phút',
    DEPARTURE_DATE_GREATER_THAN_OR_EQUAL_TO_TOMORROW: 'Thời gian khởi hành phải lớn hơn hoặc bằng ngày mai',
    EXPECTED_DATE_GREATER_THAN_OR_EQUAL_TO_DEPARTURE_DATE_PLUS_2_HOURS: 'Thời gian đến phải lớn hơn hoặc bằng thời gian khởi hành 2 giờ',
    DEPARTURE_DATE_GREATER_THAN_OR_EQUAL_TO_TRIP_START_DATE: 'Thời gian khởi hành phải lớn hơn hoặc bằng ngày bắt đầu của tuyến',
    DEPARTURE_DATE_LESS_THAN_OR_EQUAL_TO_TRIP_END_DATE: 'Thời gian khởi hành phải nhỏ hơn hoặc bằng ngày kết thúc của tuyến',
    EXPECTED_DATE_GREATER_THAN_OR_EQUAL_TO_TRIP_START_DATE: 'Thời gian đến phải lớn hơn hoặc bằng ngày bắt đầu của tuyến',
    ...
    EXPECTED_DATE_GREATER_THAN_DEPARTURE_DATE: 'Thời gian đến phải lớn hơn hoặc bằng thời gian khởi hành',
    DEPARTURE_DATE_GREATER_THAN_CURRENT_DATE: 'Thời gian khởi hành phải lớn hơn hiện tại',
    EXPECTED_DATE_GREATER_THAN_CURRENT_DATE: 'Thời gian đến phải lớn hơn hiện tại',
    ...
    TRIP_DETAIL_CODE_BETWEEN_1_AND_100_CHARACTERS: 'Mã chuyến đi phải từ 1 đến 100 ký tự',
    ...
    TRIP_DETAIL_HAS_PASSED_NOT_PAYMENT: 'Chuyến xe đã khởi hành không thể thanh toán',
    TRIP_DETAIL_HAS_PASSED_1_HOURS: 'Chuyến xe còn 1 giờ nữa sẽ khởi hành không thể đặt vé, vui lòng hãy đến phòng vé để được hỗ trợ đặt vé',
    ...
    VEHICLE_HAS_BEEN_USED_IN_OTHER_TRIP_DETAIL: 'Xe đã được sử dụng trong chuyến khác',
    ...
    VEHICLE_TYPE_IS_ENUM: 'Loại xe phải thuộc 1 trong cái loại sau: "limousine", "giường nằm", "ghế ngồi"',
    ...
    VEHICLE_TOTAL_SEAT_IS_ENUM: 'Tổng số ghế của xe phải thuộc 1 trong các giá trị sau: 34, 44, 28',
    ...
    TICKET_GROUP_CODE_ITEM_MUST_BE_STRING: 'Mã nhóm vé trong danh sách phải là chuỗi ký tự',
    ...
    TICKET_GROUP_CODE_MUST_BE_BETWEEN_1_AND_100: 'Mã nhóm vé phải có 1 đến 100 ký tự',
    TICKET_CODE_EXISTED: 'Mã vé đã tồn tại',
    TICKET_START_DATE_IS_REQUIRED: 'Ngày vé có hiệu lực không được để trống',
    TICKET_START_DATE_GREATER_THAN_CURRENT_DATE: 'Ngày vé có hiệu lực phải lớn hơn hoặc bằng ngày hiện tại',
    TICKET_END_DATE_IS_REQUIRED: 'Ngày vé hết hiệu lực không được để trống',
    TICKET_END_DATE_GREATER_THAN_TICKET_START_DATE: 'Ngày vé hết hiệu lực phải lớn hơn ngày vé có hiệu lực',
    ...
    TICKET_GROUP_ID_OR_CODE_REQUIRED: 'Id hoặc mã của nhóm vé không được để trống',
    ...
    PRICE_LIST_IS_ACTIVE_AND_IN_USE: 'Bảng giá này đang được kích hoạt và đang được sử dụng',
    ANOTHER_PRICE_LIST_IS_EXIST_IN_THIS_DATE: 'Đã tồn tại bảng giá trong khoảng thời gian này',
    PRICE_LIST_IS_EXPIRED: 'Bảng giá này đã hết hạn',
    PRICE_LIST_IS_ACTIVE: 'Bảng giá này đang được kích hoạt',
    PRICE_LIST_STATUS_INVALID: 'Trạng thái của bảng giá không hợp lệ. Chỉ nhận 1 trong 2 giá trị: "Kích hoạt", "Tạm ngưng"',
    PRICE_LIST_STATUS_IS_STRING: 'Trạng thái của bảng giá phải là chuỗi ký tự',
    START_DATE_MUST_BE_LESS_THAN_END_DATE: 'Ngày bắt đầu phải nhỏ hơn hoặc bằng ngày kết thúc',
    ...
    TRIP_EXISTED_IN_PRICE_LIST: 'Loại ghế của tuyến này đã tồn tại trong bảng giá đang hoạt động khác',
    ...
    MAX_PRICE_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0: 'Giá tối đa phải lớn hơn hoặc bằng 0',
    MIN_PRICE_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0: 'Giá tối thiểu phải lớn hơn hoặc bằng 0',
    ...
    PROMOTION_IS_ACTIVE_AND_IN_USE: 'Chương trình khuyến mãi này đang được kích hoạt và đang được sử dụng',
    ...
    MIN_OF_MAX_BUDGET_MUST_BE_GREATER_THAN_0: 'Số tối thiểu của ngân sách tối đa phải lớn hơn hoặc bằng 0',
    MAX_OF_MAX_BUDGET_IS_NUMBER: 'Số tối đa của ngân sách tối đa phải là số',
    MAX_OF_MAX_BUDGET_MUST_BE_GREATER_THAN_0: 'Số tối đa của ngân sách tối đa phải lớn hơn hoặc bằng 0',
    MAX_BUDGET_IS_REQUIRED: 'Ngân sách tối đa không được để trống',
    MAX_BUDGET_IS_NUMBER: 'Ngân sách tối đa phải là số',
    MAX_BUDGET_MUST_BE_GREATER_THAN_0: 'Ngân sách tối đa phải lớn hơn hoặc bằng 0',
    MIN_USE_BUDGET_IS_NUMBER: 'Ngân sách đã sử dụng tối thiểu phải là số',
    MIN_USE_BUDGET_MUST_BE_GREATER_THAN_0: 'Ngân sách đã sử dụng tối thiểu phải lớn hơn hoặc bằng 0',
    MAX_USE_BUDGET_MUST_BE_GREATER_THAN_0: 'Ngân sách đã sử dụng tối đa phải lớn hơn hoặc bằng 0',
    ...
    MAX_BUDGET_MUST_BE_GREATER_THAN_USED_BUDGET: 'Ngân sách tối đa phải lớn hơn ngân sách đã dùng',
    PROMOTION_STATUS_IS_ON_ACTIVE: 'Chương trình khuyến mãi đang kích hoạt nên không thể cập nhật ngày bắt đầu',
    PROMOTION_NOT_FOUND: 'Không tìm thấy chương trình khuyến mãi',
    PROMOTION_CODE_EXISTED: 'Mã khuyến mãi đã tồn tại',
    PROMOTION_STATUS_IS_STRING: 'Trạng thái chương trình khuyến mãi phải là chuỗi ký tự',
    PROMOTION_STATUS_IS_REQUIRED: 'Trạng thái chương trình khuyến mãi không được để trống',
    PROMOTION_STATUS_IS_ENUM: 'Trạng thái chương trình khuyến mãi phải thuộc 1 trong các loại sau: "Đang hoạt động", "Ngừng hoạt động"',
    ...
    MAX_OF_MAX_QUANTITY_IS_NUMBER: 'Số tối đa của số lượng áp dụng tối đa phải là số',
    MIN_OF_MAX_QUANTITY_IS_NUMBER: 'Số tối thiểu của số lượng áp dụng tối đa phải là số',
    MAX_OF_MAX_QUANTITY_MIN_0: 'Số tối đa của số lượng áp dụng tối đa phải lớn hơn hoặc bằng 0',
    MIN_OF_MAX_QUANTITY_MIN_0: 'Số tối thiểu của số lượng áp dụng tối đa phải lớn hơn hoặc bằng 0',
    ...
    MAX_QUANTITY_MUST_BE_GREATER_THAN_USED_QUANTITY: 'Số lượng tối đa phải lớn hơn số lượng đã dùng',
    MAX_QUANTITY_MUST_BE_GREATER_THAN_0: 'Số lượng áp dụng tối đa phải lớn hơn 0',
    MAX_QUANTITY_PER_CUSTOMER_MIN_1: 'Số lượng tối đa áp dụng cho mỗi khách hàng phải lớn hơn hoặc bằng 1',
    MAX_QUANTITY_PER_CUSTOMER_MIN_0: 'Số lượng tối đa áp dụng cho mỗi khách hàng phải lớn hơn hoặc bằng 0',
    MAX_QUANTITY_PER_CUSTOMER_MUST_BE_INTEGER: 'Số lượng tối đa áp dụng cho mỗi khách hàng phải 1 số nguyên',
    MAX_QUANTITY_PER_CUSTOMER_IS_REQUIRED: 'Số lượng tối đa áp dụng cho mỗi khách hàng không được để trống',
    MAX_QUANTITY_PER_CUSTOMER_IS_NUMBER: 'Số lượng tối đa áp dụng cho mỗi khách hàng phải là số',
    MAX_QUANTITY_PER_CUSTOMER_MUST_BE_GREATER_THAN_USED_QUANTITY_PER_CUSTOMER: 'Số lượng tối đa áp dụng cho mỗi khách hàng phải lớn hơn hoặc bằng số lượng cũ',
    MAX_QUANTITY_PER_CUSTOMER_MUST_BE_GREATER_THAN_0: 'Số lượng tối đa áp dụng cho mỗi khách hàng phải lớn hơn 0',
    MAX_QUANTITY_PER_CUSTOMER_PER_DAY_IS_REQUIRED: 'Số lượng tối đa áp dụng cho mỗi khách hàng mỗi ngày không được để trống',
    MAX_QUANTITY_PER_CUSTOMER_PER_DAY_IS_NUMBER: 'Số lượng tối đa áp dụng cho mỗi khách hàng mỗi ngày phải là số',
    MAX_QUANTITY_PER_CUSTOMER_PER_DAY_MUST_BE_GREATER_THAN_0: 'Số lượng tối đa áp dụng cho mỗi khách hàng mỗi ngày phải lớn hơn 0',
    MAX_QUANTITY_PER_CUSTOMER_PER_DAY_MIN_1: 'Số lượng tối đa áp dụng cho mỗi khách hàng mỗi ngày phải lớn hơn hoặc bằng 1',
    PROMOTION_ID_IS_REQUIRED: 'Id của chương trình khuyến mãi không được để trống',
    PROMOTION_ID_IS_36_CHARACTERS: 'Id của chương trình khuyến mãi phải là 36 ký tự',
    PROMOTION_ID_IS_STRING: 'Id của chương trình khuyến mãi phải là chuỗi ký tự',
    MIN_OF_MAX_QUANTITY_PER_CUSTOMER_IS_NUMBER: 'Số tổi thiểu của Số lượng tối đa áp dụng cho mỗi khách hàng phải là số',
    MIN_OF_MAX_QUANTITY_PER_CUSTOMER_MIN_0: 'Số tổi thiểu của Số lượng tối đa áp dụng cho mỗi khách hàng phải lớn hơn hoặc bằng 0',
    MAX_OF_MAX_QUANTITY_PER_CUSTOMER_IS_NUMBER: 'Số tổi đa của Số lượng tối đa áp dụng cho mỗi khách hàng phải là số',
    MAX_OF_MAX_QUANTITY_PER_CUSTOMER_MIN_0: 'Số tổi đa của Số lượng tối đa áp dụng cho mỗi khách hàng phải lớn hơn hoặc bằng 0',
    PROMOTION_LINE_CODES_IS_REQUIRED: 'Danh sách mã khuyến mãi không được để trống',
    ...
    PROMOTION_LINE_CODES_IS_STRING: 'thành phần trong danh sách mã khuyến mãi phải là chuỗi ký tự',
    ...
    PROMOTION_LINE_TYPE_IS_ENUM: 'Loại khuyến mãi phải thuộc 1 trong các loại sau: "Giảm giá sản phẩm (bằng tiền trực tiếp)", "Giảm giá sản phẩm (bằng phần trăm)"',
    ...
    START_DATE_MUST_BE_GREATER_THAN_OR_EQUAL_TO_PROMOTION_START_DATE: 'Ngày bắt đầu phải lớn hơn hoặc bằng ngày bắt đầu của chương trình khuyến mãi',
    START_DATE_MUST_BE_LESS_THAN_OR_EQUAL_TO_PROMOTION_END_DATE: 'Ngày bắt đầu phải nhỏ hơn hoặc bằng ngày kết thúc của chương trình khuyến mãi',
    END_DATE_MUST_BE_LESS_THAN_OR_EQUAL_TO_PROMOTION_END_DATE: 'Ngày kết thúc phải nhỏ hơn hoặc bằng ngày kết thúc của chương trình khuyến mãi',
    END_DATE_MUST_BE_GREATER_THAN_OR_EQUAL_TO_PROMOTION_START_DATE: 'Ngày kết thúc phải lớn hơn hoặc bằng ngày bắt đầu của chương trình khuyến mãi',
    START_DATE_MUST_BE_LESS_THAN_OR_EQUAL_TO_PROMOTION_LINE_END_DATE: 'Ngày bắt đầu phải nhỏ hơn hoặc bằng ngày kết thúc của khuyến mãi',
    ...
    PROMOTION_DETAIL_ID_MUST_BE_STRING: 'Id chi tiết khuyến mãi phải là chuỗi ký tự',
    PROMOTION_DETAIL_ID_IS_REQUIRED: 'Id chi tiết khuyến mãi không được để trống',
    PROMOTION_DETAIL_ID_MUST_BE_BETWEEN_1_AND_100_CHARACTERS: 'Id chi tiết khuyến mãi phải có từ 1-100 ký tự',
    ...
    PURCHASE_AMOUNT_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0: 'Số tiền mua phải lớn hơn hoặc bằng 0',
    REDUCTION_AMOUNT_IS_INT: 'Số tiền được giảm phải là số nguyên',
    REDUCTION_AMOUNT_GREATER_THAN_OR_EQUAL_TO_0: 'Số tiền được giảm phải lớn hơn hoặc bằng 0',
    ...
    REDUCTION_PERCENT_GREATER_THAN_OR_EQUAL_TO_0: 'Phần trăm được giảm phải lớn hơn hoặc bằng 0',
    MAX_REDUCTION_AMOUNT_MUST_BE_INT: 'Số tiền được giảm tối đa phải là số nguyên',
    MAX_REDUCTION_AMOUNT_IS_REQUIRED: 'Số tiền được giảm tối đa không được để trống',
    MAX_REDUCTION_AMOUNT_GREATER_THAN_OR_EQUAL_TO_0: 'Số tiền được giảm tối đa phải lớn hơn hoặc bằng 0',
    ...
    PERCENT_DISCOUNT_GREATER_THAN_OR_EQUAL_TO_0: 'Phần trăm được giảm phải lớn hơn hoặc bằng 0',
    PERCENT_DISCOUNT_LESS_THAN_OR_EQUAL_TO_100: 'Phần trăm được giảm phải nhỏ hơn hoặc bằng 100',
    ...
    QUANTITY_RECEIVE_MUST_BE_GREATER_THAN_OR_EQUAL_TO_1: 'Số lượng được tặng phải lớn hơn hoặc bằng 1',
    QUANTITY_BUY_OR_PURCHASE_AMOUNT_IS_REQUIRED: 'Số lượng vé mua tối thiểu hoặc số tiền mua tối thiểu không được để trống',
    ...
    ORDER_CANNOT_CANCEL_12H_BEFORE: 'Không thể huỷ vé trước 12 tiếng so với giờ khởi hàng, hãy đến trực tiếp phòng vé để huỷ',
    ...
    PROMOTION_HISTORY_TYPE_IS_REQUIRED: 'Loại lịch sử khuyến mãi không được để trống',
    ...
    STATISTICS_TYPE_MUST_BE_WEEK_OR_MONTH: 'Loại thống kê phải là tuần hoặc tháng',
    LIMIT_MUST_BE_NUMBER: 'Số lượng người cần lấy phải là số',
    START_DATE_OR_END_DATE_IS_REQUIRED: 'Ngày bắt đầu và ngày kết thúc không được để trống',
    ...
    PAYMENT_HISTORY_TYPE_IS_REQUIRED: 'Loại Lịch sử thanh toán DTO không được để trống',
    ...
    MIN_AMOUNT_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0: 'Số tiền tối thiểu phải lớn hơn hoặc bằng 0',
    MAX_AMOUNT_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0: 'Số tiền tối đa phải lớn hơn hoặc bằng 0',
