...
AuthCustomerModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [customer_auth_controller_1.AuthCustomerController],
        providers: [customer_auth_service_1.AuthCustomerService, auth_service_1.AuthService, customer_service_1.CustomerService],
        exports: [customer_auth_service_1.AuthCustomerService],
    })
], AuthCustomerModule);
